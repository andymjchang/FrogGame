...
#include "FrogAbilities/FrogAbilityRogueProjectile.h"
...
void UFrogAbilityRogueProjectile::FireProjectile()
{
	...
	for (int i = 0; i < NumProjectiles; i++)
	{
		...
		FVector ProjectileDirection = ProjectileRotation.Vector();

		// Fire projectile with modified rotation/direction
		Super::FireProjectile(SpawnLocation, ProjectileRotation, ProjectileDirection);
	}
}

//
// void UFrogAbilityProjectile::ActivateAbility(const FGameplayAbilitySpecHandle Handle,
